package top.cpjinan.akarilevel
...
import top.cpjinan.akarilevel.script.ScriptHandler.Companion.classLoader

/**
 * AkariLevel
 * top.cpjinan.akarilevel
 *
 * 插件主类。
 *
 * @author 季楠
...
object AkariLevel : Plugin() {
    ...
    override fun onDisable() {
        MemberCache.flushDirtyMembers()
        MemberCache.stopAutoSave()
